...
class LiveCapture(Capture):
    ...
    def __init__(self, interface=None, bpf_filter=None, display_filter=None, only_summaries=False, decryption_key=None,
                 ...
                 eventloop=None, ignore_corruption_warnings=False, custom_parameters=None):
        """
        ...
        :param ignore_corruption_errors: A boolean indicating whether to suppress RuntimeErrors of corrupted files.
        ...
        super(LiveCapture, self).__init__(display_filter=display_filter, only_summaries=only_summaries,
                                          ...
                                          eventloop=eventloop, ignore_corruption_warnings=ignore_corruption_warnings,
